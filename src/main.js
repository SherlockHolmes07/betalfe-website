    ...
    return h("div", { class: "overflow-x-hidden" }, [
      ...
      h("header", { 
        ...
        h("div", { 
          ...
          // Logo + Brand
          h("a", { href: "/", class: "flex items-center gap-3" }, [
            h("span", { 
              class: "text-base font-semibold tracking-tight text-white sm:text-lg" 
            }, ["Betal-FE"])
          ]),
          
          // Desktop nav
          h("nav", { 
            class: "hidden items-center gap-7 text-sm text-neutral-400 md:flex" 
          }, [
            h("a", { href: "#features", class: "hover:text-white" }, ["Features"]),
            h("a", { href: "#why", class: "hover:text-white" }, ["Why?"]),
            h("a", { href: "#docs", class: "hover:text-white" }, ["Docs"]),
...
createBetalApp(Counter).mount(document.getElementById('app'));`
            ...
            h("div", { class: "w-full" }, [
              ...
              h("ul", { class: "mt-6 space-y-3 text-sm text-neutral-300" }, [
                h("li", { class: "flex gap-2 sm:gap-3" }, [
                  h("span", { class: "mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" }),
      ...
      // Footer
      h("footer", { class: "border-t border-neutral-900" }, [
        h("div", {
